              ...
              GestureDetector(
                ...
                child: Center(
                  child: Container(
                    ...
                    child: Padding(
                      padding: const EdgeInsets.all(8.0),
                      child: Image.asset('images/tooth/2-lastest.png'),
                    ),
                  ),
                ),
              ),
              GestureDetector(
                ...
                child: Center(
                  child: Container(
                    ...
                    child: Padding(
                      padding: const EdgeInsets.all(8.0),
                      child: Image.asset('images/tooth/3-lastest.png'),
                    ),
                  ),
                ),
              ),
              ...
              GestureDetector(
                ...
                child: Center(
                  child: Container(
                    ...
                    child: Padding(
                      padding: const EdgeInsets.all(8.0),
                      child: Image.asset('images/tooth/5-lastest.png'),
                    ),
                  ),
                ),
              ),
              GestureDetector(
                ...
                child: Center(
                  child: Container(
                    ...
                    child: Padding(
                      padding: const EdgeInsets.all(8.0),
                      child: Image.asset('images/tooth/6-lastest.png'),
                    ),
                  ),
                ),
              ),
                ...
                child: Center(
                  child: Container(
                    ...
                    height: MediaQuery.of(context).size.height *
                        MediaQuery.of(context).devicePixelRatio *
                        0.040,
                    margin: EdgeInsets.fromLTRB(0, 0, 83, 361),
                    child: Padding(
                      padding: const EdgeInsets.all(8.0),
                      child: Image.asset('images/tooth/7-lastest.png'),
                    ),
                  ),
                ),
              ),
