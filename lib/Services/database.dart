...
class PatientDatabase {
  ...
  Future<String> createPatient (OurPatients patient) async {
    ...
    try {
      await _firestore.collection('Account').document('account').collection('Patients').document(patient.patientEmail).setData({
...
class DentistDatabase {
  ...
  Future<String> createDentists (OurDentists dentist) async{
    ...
    try {
      await _firestore.collection('Account').document('account').collection('Dentists').document(dentist.dentistEmail).setData({
